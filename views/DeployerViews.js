...
exports.SetRounds = class extends React.Component {
  render() {
    const { parent, defaultRounds } = this.props;
    const rounds = (this.state || {}).rounds || defaultRounds;
    return (
      <div>
        <input
          type="number"
          placeholder={defaultRounds}
          onChange={(e) => this.setState({ rounds: e.currentTarget.value })}
        />{" "}
        rounds
        <br />
